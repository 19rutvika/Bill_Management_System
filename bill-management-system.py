...
def Total():
    ...
    lbl_total.place(x=6,y=50)

    entry_total=Entry(f2,font=('aria',20,'bold'),textvariable=Total_bill,bd=6,width=15,bg="lightblue")
...
###### icon
image_icon=PhotoImage(file="bill1.png")
...
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Dosa...........Rs.60/plate",fg="black",bg="lightblue").place(x=10,y=80)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Cookies......Rs.30/plate",fg="black",bg="lightblue").place(x=10,y=110)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Tea............Rs.10/cup",fg="black",bg="lightblue").place(x=10,y=140)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Coffee........Rs.50/plate",fg="black",bg="lightblue").place(x=10,y=170)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Juice.........Rs.40/glass",fg="black",bg="lightblue").place(x=10,y=200)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Pancakes...Rs.35/plate",fg="black",bg="lightblue").place(x=10,y=230)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Eggs...........Rs.7/egg",fg="black",bg="lightblue").place(x=10,y=260)
...
#######buttons
btn_reset=Button(f1,bd=5,fg="black",bg="lightgray",font=("ariel",16,'bold'),width=10,text="Reset",command=Reset)
btn_reset.grid(row=8,column=0)

btn_total=Button(f1,bd=5,fg="black",bg="lightgray",font=("ariel",16,'bold'),width=10,text="Total",command=Total)
